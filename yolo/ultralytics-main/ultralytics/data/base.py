...
class BaseDataset(Dataset):
    ...
    def __init__(
        ...
        self.defect_preprocess = str(getattr(hyp, "defect_preprocess", "none"))
    ...
    def load_image(
        ...
        if im is None:  # not cached in RAM
            ...
            if self.channels == 3 and self.defect_preprocess != "none":
                im = apply_defect_preprocess(im, self.defect_preprocess)
