...
class Attention_org(nn.Module):
    def __init__(self, config, vis, channel_num):
        ...
        self.vis = vis
        self.KV_size = channel_num[0] + channel_num[1] + channel_num[2] + channel_num[3]
...
class Block_ViT(nn.Module):
    def __init__(self, config, vis, channel_num):
        ...
        self.attn_norm = LayerNorm3d(channel_num[0]+channel_num[1]+channel_num[2]+channel_num[3], LayerNorm_type='WithBias')
...
class ChannelTransformer(nn.Module):
    def __init__(self, img_size, vis=False, channel_num=[64, 128, 256, 512], patchSize=[32, 16, 8, 4]):
        super().__init__()
